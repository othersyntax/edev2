<div class="modal inmodal" id="addModalKelulusan" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                {{-- <i class="fa fa-cogs modal-icon"></i> --}}
                <h4 class="modal-title">Maklumat Kelulusan</h4>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>No Rujukan <small>(jika ada)</small></label>
                ...
                <form id="form" action="#" class="wizard-big">
                    {{ Form::select('proj_negeri', dropdownUser(), null, ['class'=>'form-control dual_select', 'id'=>'proj_negeri', 'multiple']) }}
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-white" data-dismiss="modal">Batal</button>
                <button type="button" class="btn btn-primary addBayaran">Tambah</button>
            </div>
