            ...
            <form id="frmUpload">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label>Perihal</label>
                        <textarea class="form-control" name="proj_doc_perihal" id="proj_doc_perihal" cols="30" rows="3"></textarea>
                    </div>
                    <div class="form-group">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary btnMuatNaik">Muat naik</button>
                </div>
            </form>
        </div>
    </div>
