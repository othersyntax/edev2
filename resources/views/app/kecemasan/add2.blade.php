        ...
        <div class="ibox product-detail">
            <div class="ibox-content">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <a href="/permohonan/kecemasan/main" class="btn btn-xs btn-white">Kembali</a>
                        <a href="/permohonan/kecemasan/ubah/{{ $projek->projek_id }}" class="btn btn-xs btn-primary">Kemaskini</a>
                        <a href="/permohonan/kecemasan/selesai/{{ $projek->projek_id }}" class="btn btn-xs btn-warning float-right selesaiMohon">Hantar Permohonan</a>
                    </div>
                </div>
            </div>
        </div>
...
$(document).ready(function(){
    ...
    $(document).on('click', '#addUnjuran', function (e) {
        ...
        if(cekAmaunUnjuran()){
            ...
            swal({
                title: "Unjuran",
                text: "Amuan unjuran tidak boleh melebihi Kos Dipohon",
                type: "error"
            });
        }
    ...
    // $('.selesaiMohon').on('click', function() {
    //     let projID= $(this).val();
    //     swal({
    //             title: "Adakah anda pasti?",
    //             text: "Sila pastikan maklumat projek telah lengkap",
    //             type: "warning",
    //             showCancelButton: true,
    //             confirmButtonColor: "#DD6B55",
    ...
    //                 $.ajax({
    //                     type: "get",
    //                     url: "'/permohonan/baru/selesai/" + projID,
    //                     dataType: "json",
    //                     success: function (response) {
    //                         if (response.status == 404) {
    //                             swal("Dibatalkan", response.message, "error");
    //                         } else {
    //                             window.location = 'permohonan/baru/main';
    //                         }
    //                     }
    //                 });
    //             } else {
    //                 swal("Dibatalkan", "Permohonan tidak dihantar untuk pengesahan", "error");
    //             }
    //         });    });
});
