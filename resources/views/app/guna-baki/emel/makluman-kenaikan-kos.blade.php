...
<body>
    ...
    <h3>PEMAKLUMAN KENAIKAN KOS PROJEK OLEH {{ strtoupper($projPemilik) }}</h3>
    <p>
        Unit Bajet RMK, Bahagian Pembangunan mengambil maklum bahawa terdapat kenaikan kos bagi projek <strong>{{ $projTitleAsal }}</strong>, dan <strong>{{ $projPemilik }}</strong> akan membiayai kenaikan kos dengan menggunakan baki penjimatan di bawah siling BP00600 yang sedia ada.<br><br><br>
