            ...
            <div class="ibox-content">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="m-t-md">
                            <h2 class="product-main-price" >RM <span id="main_amaun">@duit($projek->proj_kos_mohon)</span> <small class="text-muted">Kos projek</small> </h2>
                        </div>
                        <hr>
...
$(document).ready(function(){
    ...
    $(document).on('click', '.emelPemakluman', function (e) {
        ...
        $.ajax({
            type: "post",
            url: "/projek/baki/mohon/"+projekID,
            data: null,
            dataType: "json",
            success: function (response) {
                if (response.status == 400) {
