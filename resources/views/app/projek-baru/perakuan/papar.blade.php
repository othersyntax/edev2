        ...
        <div class="ibox product-detail">
            <div class="ibox-content">
                <div class="row">
                    ...
                    <form action="/permohonan/baru/perakuan-satu" method="POST">
                        @csrf
                        <input type="hidden" name="projek_id" value="{{ $projek->projek_id }}">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label><strong>Perakuan</strong></label>
                                {{ Form::select('proj_wf_sah', ['1'=>'--Sila pilih--', '2'=>'Diperakukan' , '3'=>'Tidak Diperakukan'], $projek->proj_wf_sah, ['class'=>'form-control', 'id'=>'proj_wf_sah']) }}
                            </div>
                        </div>
                        <div class="col-md-12">
                            <a href="/permohonan/baru/perakuan" class="btn btn-xs btn-white">Kembali</a>
