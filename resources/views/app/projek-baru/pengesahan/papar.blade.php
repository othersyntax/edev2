        ...
        <div class="ibox product-detail">
            <div class="ibox-content">
                <div class="row">
                    ...
                    <form action="/permohonan/baru/pengesahan-satu" method="POST">
                        @csrf
                        <input type="hidden" name="projek_id" value="{{ $projek->projek_id }}">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label><strong>Pengesahan</strong></label>
                                {{ Form::select('proj_wf_semak', ['1'=>'--Sila pilih--', '2'=>'Disahkan' , '3'=>'Tidak Disahkan'], $projek->proj_wf_semak, ['class'=>'form-control', 'id'=>'proj_wf_semak']) }}
                            </div>
                        </div>
                        <div class="col-md-12">
                            <a href="/permohonan/baru/pengesahan" class="btn btn-xs btn-white">Kembali</a>
