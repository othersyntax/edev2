                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                {{ Form::select('carian_type', ['Kod'=>'Projek Kategori'], session('carian_type'), ['class'=>'form-control', 'id'=>'carian_type']) }}
...
<div class="modal inmodal fade" id="editStateModal" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="hidden" id="proj_kategori_id">
                <div class="row">
                    <div class="col-lg-12">
                        <ul id="save_msgList"></ul>
                    </div>
                ...
                success: function (response) {
                    ...
                    $.each(response.KategoriProjek, function (key, item) {
                        $('tbody').append('<tr>\
                            ...
                            <td class="text-center">' + item.pro_kat_status + '</td>\
            ...
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        ...
                        swal("Dibatalkan", "Rekod Kategori Projek tidak dipadam", "error");
                    }
                });
        });
